...
CAN_filter_t filters[] = {
  {0, 0, 0, 0,
   0xFFFF0000 | STM32_CAN::makeFilter16(CANBUS_ID_COOLANT_TEMP_WEBASTO, STANDARD_FORMAT, REMOTE_FRAME),
   0xFFFF0000 | STM32_CAN::makeFilter16(CANBUS_ID_COOLANT_TEMP_WEBASTO | CANBUS_ID_WRITE_MODIFIER, STANDARD_FORMAT, DATA_FRAME)},
  {1, 0, 0, 1,
   0xFFFF0000 | STM32_CAN::makeFilter16(CANBUS_ID_BATTERY_VOLTAGE, STANDARD_FORMAT, REMOTE_FRAME),
   0xFFFF0000 | STM32_CAN::makeFilter16(CANBUS_ID_BATTERY_VOLTAGE | CANBUS_ID_WRITE_MODIFIER, STANDARD_FORMAT, DATA_FRAME)},
};
