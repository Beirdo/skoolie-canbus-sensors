...
#define PIN_CAN_INT           1   // PA_1
#define PIN_USART2_TX         2   // PA_2
#define PIN_USART2_RX         3   // PA_3
#define PIN_SPI_SS            4   // PA_4
#define PIN_SPI_SCK           5   // PA_5
#define PIN_SPI_MISO          6   // PA_6
#define PIN_SPI_MOSI          7   // PA_7
#define PIN_SWDIO             10  // PA_13
#define PIN_SWDCLK            11  // PA_14
#define PIN_CAN_EN            12  // PB_1
#define PIN_BOOTROM_SEL       13  // PB_8
#define PIN_I2C_SDA           14  // PF_0
#define PIN_I2C_SCL           15  // PF_1
